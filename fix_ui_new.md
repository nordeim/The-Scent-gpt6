<think>
To address the critical mismatches between the current implementation and the sample UI for the main landing page, I need to focus on the following areas:
...
Proceeding step-by-step with the code changes.
